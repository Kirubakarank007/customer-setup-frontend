...
function CongratsPopUp(props:{facilityNickName:string}){
  ...
  return (
   <Box >
    {
        windowwidth<678?(<img onClick={()=>navigator("/")} src="./assets/ArrowLeft.png" alt="" width={24} height={24}/>):(null)
    }
    <InnerBox >
    
   {
            windowwidth>678?(<Cancel onClick={()=>navigator("/")} style={{justifyContent:"flex-end", position:"absolute", left:"92%", top:"-15px"}}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="#fffff">
      ...
      <Center>
           <Tick>
            ...
            <CompanyText> You can find in under <CompnyInner>‘My company’</CompnyInner> </CompanyText>
            <AddMoreLink>Add more details for this facility</AddMoreLink>
      </Center>
    </InnerBox>
   <WrapButton >
   <AddAnother onClick={()=>navigator("/Facility")}>Add another Facilities</AddAnother>
